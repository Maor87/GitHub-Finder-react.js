...
function User() {
  ...
  useEffect(() => {
    ...
    getUserData()
  }, [dispatch, params.login]) // array brackets to stop running infinite
      ...
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 
         ...
         <div className="custom-card-image mb-6 md:mb-0">
          <div className="rounded-lg shadow-xl card image-full position-relative">
            <figure>
              <img src={avatar_url} alt="" style={{width: '100%'}}/>
            </figure>
            <div className="card-body justify-end fixed bottom-0 left-0 position-absolute">
